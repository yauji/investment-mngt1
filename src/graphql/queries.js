...
`;
export const getFxRate = /* GraphQL */ `
  query GetFxRate($id: ID!) {
    getFxRate(id: $id) {
      id
      currency
      date
...
`;
export const listFxRates = /* GraphQL */ `
  query ListFxRates(
    $filter: ModelFxRateFilterInput
    $limit: Int
    $nextToken: String
  ) {
    listFxRates(filter: $filter, limit: $limit, nextToken: $nextToken) {
      items {
        id
        currency
        date
...
`;
export const fxRatesByCurrencyDate = /* GraphQL */ `
  query FxRatesByCurrencyDate(
    $currency: Currency
...
`;
export const fxRatesByDate = /* GraphQL */ `
  query FxRatesByDate(
    $date: String
    $sortDirection: ModelSortDirection
    $filter: ModelFxRateFilterInput
